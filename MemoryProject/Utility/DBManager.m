...
-(void)createDB{
    if ([self.db open]){
        NSString *db005TableSql = @"CREATE TABLE db005 (accountKey  VARCHAR (30) NOT NULL UNIQUE PRIMARY KEY,account VARCHAR (30) NOT NULL,accountPWD  VARCHAR (250) NOT NULL,accountDesc VARCHAR (30)  NOT NULL,dataType VARCHAR (8) NOT NULL)";
