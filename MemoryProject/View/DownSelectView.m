...
@interface DownSelectView () <UITableViewDataSource, UITableViewDelegate>
...
- (void)clickBtnClicked
{
    ...
    for (UIView *subview in self.superview.subviews) {
        if ([subview isKindOfClass:[DownSelectView class]] && subview != self) {
            DownSelectView *donwnSelectedView = (DownSelectView *)subview;
